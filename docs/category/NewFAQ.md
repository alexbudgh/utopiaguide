...
**A:** In protection, it is best to set draft rate to 0 so that you do not draft while you are populating. For hostilities and war it is best to consider your ppa(population per acre)and draft accordingly. See \*blank\* for more info. More generally, higher dr give more raw power, but lowers BE making the various mods given by buildings less effective.

**Q: What is military wages? What should I put them to?**

**A:** Military wages modify the amount each spec/elite costs per tick. Over time, raising or lowering wages will raise or lower military efficiency. It takes 3 days of higher wages for the military efficiency to go from -7%(50% wages) to +7%(200% wages).
...
When to Ambush: Before your enemy's army returns back home with your land - other wise you cannot ambush them.
...
**Q: Someone said that offense is better than defense in Utopia. Is this the case? Why is offense more sustainable?**
...
**A:** In short - yes, you can play without calculating everything but you should at minimum know HOW everything is calculated. For example the attack war room tells you what percentage of the defense value you are sending in offensive points - knowing that there is a random factor of about 3 percent means you should make sure this percentage showing is 104% or above so that your army does not bounce. Your province might not be as finely tuned as other provinces that are more planned out strategically by calculating everything. But you can still play without a calculator and there are many tools that can help you with this as well.

**Q:I want to be a hybrid, but my monarch said this isn't viable. Why isn't it viable? Can they be viable? Can I op without being a "hybrid?"**

**A:**

### Advanced Game Play Questions/Starting Monarch Questions

**Q: What is nw-efficiency? What are the different uses of looking at offense/nw as opposed to offense/acres. What about other nw v. land comparisons?**
...
**Q: Why would I fit my race/pers within a KD-wide scheme? How can I think about more effective KD-wide schemes?**
...
**Q: How can I use a program like pimp in order to better plan wars? How do I know which ops to use when?**
...
### Top Game Play Questions/Advanced Monarch Questions

**Q: How do I run a bank?**

**A:**

**Q: What is a killer? Why do kd's run them?**

**A:**

**Q: What kind of agreements do top kd's make with eachother?**

**A:**

**Q: How do you plan waves based on NW?**

**A:**

**Q: Should you do nm runs and ns runs congruently?**

**A:**

**Q: Why does attack time matter so much for wars? Why do so many top kd's WD from wars even when they are ahead?**

**A:**

**Q: What is Absalom? Do they work together? If my KD isn't in absalom, do I have a chance?**

**A:**

**Q: How do people use bots and IRC in top kd's?**

**A:**

**Q: A KD I warred killed a dragon within 5 minutes of it dropping. How did they do this?**

**A:**

**Q: I want to go for a land crown! What determines a good race/personality for this?**
...
**Q: I keep hearing about certain third-party tools like "angel," "utopia pimp," and "IRC." Are these useful? Where do I get them? How do I use them?**

**A:**

**Q: What are some IRC channels I can go to for more help?**

**A:**

You can go to the Utopia server here: irc.utonet.org
...
You can also communicate in the forums to find players that might be willing to talk on IRC to help you or invite you into a new kingdom if they are recruiting.

**Q: What is a good setup for "Advanced Columns" on Utopia Pimp?**

**A:**

**Q: I'm a t/m, how do I use columns on pimp to be more effective?**

**A:**

**Q: I'm an attacker, how do I use columns on pimp to be more effective?**
...
[http://forums.utopia-game.com/showth...ealest-Returns](http://forums.utopia-game.com/showth...ealest-Returns)

[http://forums.utopia-game.com/showth...e-advantageous](http://forums.utopia-game.com/showth...e-advantageous)

[http://www.godlygaming.org/category/pro-tips/](http://www.godlygaming.org/category/pro-tips/)

[http://forums.utopia-game.com/showthread.php?622799-Quick-Tips](http://forums.utopia-game.com/showthread.php?622799-Quick-Tips)
