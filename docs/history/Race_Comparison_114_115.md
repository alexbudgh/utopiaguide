# Race Comparison: Age 114 → Age 115

Only rows that changed are shown. Unchanged stats (e.g. Soldier 3/0 · 0.75nw across all races) are omitted.
...
| | Age 114 | Age 115 |
| --- | --- | --- |
| Arcane Surge trigger | Below 35% mana | Below 40% mana |
