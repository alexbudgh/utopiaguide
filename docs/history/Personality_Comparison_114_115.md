# Personality Comparison: Age 114 → Age 115

Only rows that changed are shown. Personalities with no changes are omitted.
...
| | Age 114 | Age 115 |
| --- | --- | --- |
| Name | Chaotic Affliction *(Active)* | Blasphemous Might *(Passive)* |
| Effect | +10–30% random damage bonus for 2 ticks; 23-tick cooldown | Recover 1% Stealth after a failed offensive spell cast |
...
| | Age 114 | Age 115 |
| --- | --- | --- |
| Name | Black Magic | Dark Pact |
| Effect | Kills 1% of target's peasants per successful offensive instant spell | After each successful attack: 10% of killed units → Wizards, 20% → Soldiers, 10% → Peasants |
...
| | Age 114 | Age 115 |
| --- | --- | --- |
| Name | Divine Blessing | Holy Inquisition |
| Effect | All daily bonuses doubled | Successful War/Hostile attacks suppress 15% of target's science effectiveness and reduce Book Generation by 20% for 6–8 ticks (does not stack) |
...
| | Age 114 | Age 115 |
| --- | --- | --- |
| Name | Dragon's Wrath | Interdiction |
| Effect | 3% of raw offence deals damage to dragon on dragon attacks | Successful War attacks destroy 10% of target's gold, 25% of runes, and 20% of food |
...
| | Age 114 | Age 115 |
| --- | --- | --- |
| Name | Honour & Glory | Heroes Culling |
| Effect | +2.5% extra honor on all successful attacks | Successful Massacres kill +7% additional peasants and 2.5% additional thieves and wizards |
