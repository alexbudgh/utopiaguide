...
SoMs and other intel operations' accuracy is dependent on the number of thieves that succeed in the operation. The range of accuracy runs from +/-3% to +/-25%. To achieve the minimum of randomness 50% of the senders thieves need to gather intel on the target province.
