...
**Unique — General's Authority** *(Passive)*
...
While above 40% mana, all spells gain +20% Wizard Effectiveness (WPA).
...
Rogue provinces may perform thievery operations even while overpopulated.
...
**Unique — Battle Cry** *(Passive)*
Upon a successful attack, the attack destroys 1% of the target's total population.
